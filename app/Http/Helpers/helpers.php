                      ...
                      if (!empty($sponsor))
                       {
                        ...
                        $sp_status=$Sposnor_status->active_status;
                        $rank=$Sposnor_status->rank;
                        $package = $Sposnor_status->package;
                      }
                      else
                      {
                        $Sposnor_status =array();
                      ...
                      $pp=0;
                       if($sp_status=="Active")
                       {
                         if($cnt==1 && $Sposnor_cnt>=$cnt)
                          ...
                          if($cnt>=6 && $cnt<=10 && $Sposnor_cnt>=$cnt)
                          {
                            $pp= $amount*2;

                          }  
                           if($cnt>=11 && $cnt<=13 && $Sposnor_cnt>=$cnt)
                          {
                            $pp= $amount*5;

                          }  
                         
                          if($cnt==14 && $Sposnor_cnt>=$cnt)
                          {
                            $pp= $amount*10;

                          }  

                          if($cnt==15 && $Sposnor_cnt>=$cnt)
                          {
                            $pp= $amount*20;
...
function add_direct_income($id,$amt,$compound)
{
