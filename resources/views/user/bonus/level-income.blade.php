<div id="main-content" class="flex-grow-1 m-3">
    <nav class="navbar navbar-expand-lg sticky-top shadow-sm main-header">
        <div class="container-fluid">
            ...
            <span class="navbar-brand text-capitalize text-white mb-0 h1 d-none d-sm-inline-block"> Generation Income</span>
...
<div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div class="card h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        <div>
                            <h5 class="mb-1">Generation Income</h5>
    ...
    @empty
        <div class="col-12">
                No Generation Income data found.
        </div>
    @endforelse
</div>
