...
<body id="auth-body">
    ...
    <div class="login-card">
        ...
        <input type="hidden" name="from" value="/login/">                                                     <div class="input-group">
                    ...
                    <input type="text" class="input-field" name="login" value="" required autocomplete="username" placeholder="Your Login" required>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <p>Please enter your email address to receive a password reset link.</p>
                      ...
                      <input type="hidden" name="csrf" value="0b79d92eb288ceca23b6f072b5f81fcd">
        <input type="hidden" name="from" value="/login/">                <div class="input-group" style="text-align: left;">
