...
<body>
        ...
        <div class="off-socials">
            <a href="https://t.me/temining_channel" target="_blank" rel="noopener noreferrer" class="social-link">
                <div class="social-icon">
                    <svg viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M9.78 18.65l.28-4.23 7.68-6.92c.34-.31-.07-.46-.52-.19L7.74 13.3 3.64 12c-.88-.25-.89-.86.2-1.08l11.96-4.4c.79-.29 1.45.12 1.23.93l-1.93 9.04c-.23.94-.84 1.15-1.59.71L12.6 15.3l-2.25 2.15c-.23.24-.43.43-.81.43z"/></svg>
                </div>
            ...
            <a href="https://t.me/temining_group" target="_blank" rel="noopener noreferrer" class="social-link">
                <div class="social-icon">
                    <svg viewBox="0 0 24 24" width="36px" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M9.78 18.65l.28-4.23 7.68-6.92c.34-.31-.07-.46-.52-.19L7.74 13.3 3.64 12c-.88-.25-.89-.86.2-1.08l11.96-4.4c.79-.29 1.45.12 1.23.93l-1.93 9.04c-.23.94-.84 1.15-1.59.71L12.6 15.3l-2.25 2.15c-.23.24-.43.43-.81.43z"/></svg>
                </div>
    ...
    <style>:root {
        ...
        *, *:before, *:after {
        ...
        .div-block { display: flex; justify-content: space-between; align-items: center; width: 100%; gap: 16px; }
        .div-block-2 { display:flex; align-items:center; gap:28px; }
        .brand { display: flex; align-items: center; font-family: Bowler, sans-serif; font-size: 24px; font-weight: 700; color: var(--dark-slate-grey); text-decoration: none; }
        ...
        .nav-link { color: var(--text-muted); font-weight: 500; transition: color 0.3s ease; text-decoration: none; }
        ...
        .roadmap-content {
         ...
         .roadmap-content h3 { font-size: 22px; color: var(--sandy-brown); }
        ...
        @media screen and (max-width: 991px) {
            ...
            .nav-menu, .contacts-block { display: none; }
            .hero-section h1 { font-size: 48px; }
            .description-grid { grid-template-columns: 1fr; gap: 40px; }
            .roadmap-timeline::after { left: 10px; }
            .roadmap-item { width: 100%; padding-left: 50px; padding-right: 0; }
            .roadmap-item.left::after, .roadmap-item.right::after { left: 0; }
        ...
        @media screen and (max-width: 767px) {
            ...
            .description-text h2, .roadmap-section h2, .testimonials-section h2 { font-size: 32px; }
        }
...
.testimonial-card {
  min-width: 0;            /* на всякий случай, если родитель flex/grid */
  overflow: hidden;        /* чтобы не появлялся горизонтальный скролл */
}

.testimonial-text {
  max-width: 100%;
  white-space: pre-wrap;    /* сохраняем переносы из текста и можно переносить строки */
  overflow-wrap: anywhere;  /* разрешаем переносить даже длинные «слова» */
  word-break: break-word;   /* фолбэк для старых браузеров */
  hyphens: auto;            /* мягкие переносы для обычных слов */
}

.testimonial-text a {
  word-break: break-all;    /* если в отзыве есть длинная ссылка — пусть ломается */
}
    ...
    <main>
        <section class="hero-section">
            <div class="container hero-content">
                <h1>About <span>TEMining</span></h1>
                <p>We are a forward-thinking investment company dedicated to harnessing the power of technology and financial expertise to deliver exceptional returns for our clients.</p>
            </div>
        </section>
            ...
            <div class="container">
                <div class="description-grid">
                    <div class="description-text">
                        ...
                        <p>At the core of TEMining lies a sophisticated, AI-driven trading system that analyzes market trends with unparalleled speed and accuracy. Our vision is to democratize access to high-yield investment opportunities, making them accessible, transparent, and secure for everyone.</p>
                    ...
                    <div class="roadmap-timeline">
                        <div class="roadmap-item left">
                            <div class="roadmap-content">
                                ...
                                <p>Official launch of the TEMining platform. Onboarding of the first 1,000 investors and deployment of initial capital into automated trading algorithms.</p>
                            </div>
                        </div>
                        <div class="roadmap-item right">
                            <div class="roadmap-content">
                                <h3>Q4 2025 - Expansion</h3>
                                <p>Introduction of new investment plans with varied risk profiles. Launch of the multi-level referral program to expand our community.</p>
                            </div>
                        </div>
                        <div class="roadmap-item left">
                            <div class="roadmap-content">
                                <h3>Q1 2026 - Mobile Integration</h3>
                                <p>Development of the TEMining mobile application for iOS and Android, providing on-the-go access to investment portfolios.</p>
                            </div>
                        </div>
                        <div class="roadmap-item right">
                            <div class="roadmap-content">
                                <h3>Q2 2026 - Diversification</h3>
                                <p>Expansion into new asset classes, including decentralized finance (DeFi) staking and yield farming protocols, to enhance returns.</p>
                            </div>
                        </div>
                         <div class="roadmap-item left">
                            <div class="roadmap-content">
                                <h3>Q3 2026 - Global Reach</h3>
                                <p>Establishing regional offices in Asia and Europe. Full localization of the platform into 5 new languages to better serve our global client base.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
https://bscscan.com/tx/0x5cfb9cb49e202aca2a3941b748fdacb3e7c8b76faabe330d70b9efd8d5642699"</p>
                    <div class="testimonial-author">
                        ...
                        <div>
                            ...
                            <div class="testimonial-card">
                    <p class="testimonial-text">"?? TEMINING ?? Paying !!
My PROFIT: ROI 108%
...
Transaction: b23aea8bac1fff6d4ddc149af671e8896f9bf84ed69ca6e8f5ffefce35b616a2"</p>
                    <div class="testimonial-author">
                        ...
                        <div>
                            ...
                            <div class="testimonial-card">
                    <p class="testimonial-text">"https://tronscan.org/#/transaction/12ff527ad8e60bb1e610dfb030a40599d39a61a7d6f8caa0843215ea3649d0ed"</p>
                    <div class="testimonial-author">
                        ...
                        <div>
                            ...
                            <div class="testimonial-card">
                    <p class="testimonial-text">"https://blockchair.com/litecoin/transaction/291756b7d763394bb4f765fb178564becfb441f0b2caef2e55b605f4749b31ef"</p>
                    <div class="testimonial-author">
                        ...
                        <div>
                            ...
                            <div class="testimonial-card">
                    <p class="testimonial-text">"https://bscscan.com/tx/0x356e3937487b599aacfeaabfd758317d892a864c8dee33cb032e3806c3e75c21"</p>
                    <div class="testimonial-author">
                        ...
                        <div>
                            ...
                            <div class="testimonial-card">
                    <p class="testimonial-text">"https://tronscan.org/#/transaction/f974c69e09208afafd66e9fa708231356672dc83a4866f7f7fdac21328f0c68d"</p>
                    <div class="testimonial-author">
                        ...
                        <div>
                            ...
                            <div class="testimonial-card">
                    <p class="testimonial-text">"https://bscscan.com/tx/0xdb91a1000b4fccd8d9c1b7e8af04cde2638b88495ac2f6cebcc824bd62a0ccef"</p>
                    <div class="testimonial-author">
...
Transaction a546b413aeceb9d92cb2342b12708d22a78c230b0776fc40093d605834989bb8"</p>
        ...
        <div class="pagination-wrapper">
            <div class="Zebra_Pagination"><ol class="pagination"><li class="page-item disabled"><a href="javascript:void(0)" class="page-link">&#8249;</a></li><li class="page-item active"><a href="index.html" class="page-link">1</a></li><li class="page-item"><a href="index%EF%B9%96pagination=2.html" class="page-link">2</a></li><li class="page-item"><a href="index%EF%B9%96pagination=3.html" class="page-link">3</a></li><li class="page-item"><a href="index%EF%B9%96pagination=2.html" class="page-link">&#8250;</a></li></ol></div>        </div>
        
                <h2 style="margin-top: 80px;">Video Testimonials</h2>
        <div class="video-testimonials-grid">
                            <div class="video-card">
                    <iframe src="https://www.youtube.com/embed/Gyp5PRFXdgM" title="Video review" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                            <div class="video-card">
                    <iframe src="https://www.youtube.com/embed/jgfvwPLrwfo" title="Video review" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    (function(){
      ...
      function openOff(){ off.classList.add('open'); backdrop.classList.add('open'); off.setAttribute('aria-hidden','false'); toggle.setAttribute('aria-expanded','true'); backdrop.removeAttribute('hidden'); document.documentElement.style.overflow='hidden'; }
      function closeOff(){ off.classList.remove('open'); backdrop.classList.remove('open'); off.setAttribute('aria-hidden','true'); toggle.setAttribute('aria-expanded','false'); setTimeout(()=>{ document.documentElement.style.overflow=''; backdrop.setAttribute('hidden',''); }, 300); }
      ...
      window.addEventListener('keydown', e=>{ if (e.key === 'Escape') closeOff(); });
